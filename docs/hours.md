...
| ------- | ------------ | ------------- | --------------- | -------------- | ------------ | ------------- | ----------- | ----- |
| Juuso   | 1            | 1             | 8 cypress,path to prod,etc  | 2 daily,debug     | 4 path to http, bugs  | -             | 0.5           | 16.5     |
| Isak    | 1            | -             | 0,5               | 2,5              | -            | 2,5             | 11           | 15    |
...
| Isak    | 4            | 5,5             | 5               | -              | 2            | -             | -           | 16,5     |
| Sami S. | 0.5 demo            | -             | -               | -              | 2 demo            | -             | -           | 2.5     |
| Sami M. | 2 updating demo slides            | -             | -               | -              | 2 demo            | -             | -           | 4     |
| Pia     | -            | -             | -               | -              | 2 demo           | -             | -           | 2    |
| Joni    | -            | -             | -               | 2 bug fixing | 2 demo      | -             | -           | 4     |


|         | Juuso | Isak | Sami.S | Sami.M | Pia | Joni |
| ------- | ------------ | ------------- | --------------- | -------------- | ------------ | ------------- |
| Total hours: | 180.5 h | 188,5             | 182.5               | 191.5              | 185 h            | 179h          |
